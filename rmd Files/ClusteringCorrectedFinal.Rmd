...
```{r}
library(readr)
clusdataset <- read.csv("Dataset/new_datasetforDM.csv")
View(clusdataset)
```
...
### Average silhouette coeffecient for k=3
...
### Average silhouette coeffecient for k=9
...
```{r}
### Total within-cluster sum of squares for k=3
...
```{r}
### Total within-cluster sum of squares for k=10
...
```{r}
clusdataset2 <- read.csv("Dataset/new_datasetforDM.csv")
...
```{r}
clusdataset3 <- read.csv("Dataset/new_datasetforDM.csv")
```
